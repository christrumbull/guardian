...
class Mage_Customer_Model_Customer extends Mage_Core_Model_Abstract
{
    ...
    public function authenticate($login, $password)
    {
        ...
        if (!$this->validatePassword($password)) {
            throw Mage::exception('Mage_Core', Mage::helper('customer')->__('Invalid login or password. <br/><br/> <strong>Attention Returning Customers:</strong> Due to the recent changes that were made to our website we no longer have access to customer account information that was created prior to <strong>June 17, 2014.</strong>'),
